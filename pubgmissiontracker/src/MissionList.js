    ...
    return [
      {
        ...
        "Missions": [
          ...
          CreateMission("[Linked Mission: 3/5] Deal at least 3000 damage by any means", 160),
          CreateMission("[Linked Mission: 4/5] Win a Chicken Dinner in Squads", 160),
          CreateMission("[Linked Mission: 5/5] Play 3 games on Miramar where you met all of the following conditions:Survived...", 320),
      ...
      },
      {
        ...
        "Missions": [
          ...
          CreateMission("[Linked Mission: 3/4] Travel at least 4km in any vehicles on Sanhok", 40),
          CreateMission("[Linked Mission: 4/4] Destroy helmets 5 times in Sanhok", 60),
          ...
          CreateMission("[Linked Mission: 3/5] Kill a player using an AR on Sanhok", 40),
          CreateMission("[Linked Mission: 4/5] Kill a player using a Shotgun on Sanhok", 40),
